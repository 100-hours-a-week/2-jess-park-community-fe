    ...
    const CommentDelete = () => {
        Dialog(
            ...
            async () => {
                ...
                if (!response.ok) {
                    Dialog('삭제 실패', '댓글삭제에 실패했습니다');
                    return;
                }

                if (response.status === HTTP_OK)
                    location.href = '/board.html?id=' + postId;
            },
        );
    };
    ...
    const  CommentModify = () => {
        ...
        saveButton.onclick = async () => {
            ...
            cancelButton.onclick = () => {
                ...
                commentInfoWrap.removeChild(cancelButton); //취소버튼 제거
            };
